...
public class InlineResponse401   {
   ...
   * @return message
   **/
  @Schema(example = "fail", description = "")
  ...
  public InlineResponse401 data(Object data) {
    this.data = data;
    return this;
  }
  ...
  public InlineResponse401 status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.message, inlineResponse401.message) &&
        Objects.equals(this.data, inlineResponse401.data) &&
