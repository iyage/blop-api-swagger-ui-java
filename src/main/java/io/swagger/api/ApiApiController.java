...
public class ApiApiController implements ApiApi {
    ...
    public ResponseEntity<InlineResponse201> adUser(@Parameter(in = ParameterIn.DEFAULT, description = "Create a new user", required=true, schema=@Schema()) @Valid @RequestBody V1RegisterNewUserBody body) {
    ...
    public ResponseEntity<InlineResponse200> delete() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<InlineResponse200> login(@Parameter(in = ParameterIn.DEFAULT, description = "requestDto to authenticate user", required=true, schema=@Schema()) @Valid @RequestBody V1AuthenticateBody body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"data\" : { },\n  \"message\" : \"success\",\n  \"status\" : 200\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<InlineResponse200> update(@Parameter(in = ParameterIn.DEFAULT, description = "requestDto to update user profile", required=true, schema=@Schema()) @Valid @RequestBody V1UpdateProfileBody body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<InlineResponse200>(objectMapper.readValue("{\n  \"data\" : { },\n  \"message\" : \"success\",\n  \"status\" : 200\n}", InlineResponse200.class), HttpStatus.NOT_IMPLEMENTED);
